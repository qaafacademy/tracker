...
var CACHE = 'qaaf-tracker-1.4.0';
var FILES = ['./', 'index.html', 'app.css?v=1.4.0', 'config.js?v=1.4.0', 'app-core.js?v=1.4.0', 'app-views.js?v=1.4.0',
  'app-pages.js?v=1.4.0', 'app-actions.js?v=1.4.0', 'manifest.webmanifest', 'assets/logo-color.png', 'assets/logo-white.png',
