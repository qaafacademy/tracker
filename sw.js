...
var CACHE = 'qaaf-tracker-1.3.1';
var FILES = ['./', 'index.html', 'app.css?v=1.3.1', 'config.js?v=1.3.1', 'app-core.js?v=1.3.1', 'app-views.js?v=1.3.1',
  'app-pages.js?v=1.3.1', 'app-actions.js?v=1.3.1', 'manifest.webmanifest', 'assets/logo-color.png', 'assets/logo-white.png',
